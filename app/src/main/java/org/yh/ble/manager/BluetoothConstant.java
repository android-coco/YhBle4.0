...
public final class BluetoothConstant
{
    public static UUID UUID_SERVICE = UUID
            .fromString("0000ffb0-0000-1000-8000-00805f9b34fb"); // 服务UUID
    public static UUID UUID_CHARACTERISTIC = UUID
            .fromString("0000ffb2-0000-1000-8000-00805f9b34fb"); // 蓝牙发数据特征UUID
    public static UUID UUID_RECEIVER_CHAR = UUID
            .fromString("0000ffb2-0000-1000-8000-00805f9b34fb"); // 蓝牙收数据特征UUID
